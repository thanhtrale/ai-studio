...
Observed, not theorised, in the image arm this module comes from: a real run
left `sd-server.exe` alive holding 444 MiB after its parent was terminated.
A `llama-server.exe` holding a whole quantised model is the same orphan.
